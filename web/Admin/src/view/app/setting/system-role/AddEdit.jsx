          ...
          <VStack spacing="25" mb="10px" alignItems="start">
            <FormControl required>
              ...
              <CustomInput
                ...
                placeholder="Please enter system role"
              />
            </FormControl>
            <FormControl required>
              <FormLabel
              ...
              <CustomSelect defaultValue={1} id="unnamed-select">
                <StyledOption value={1}>Peter Parker</StyledOption>
                <StyledOption value={2}>Max Heal</StyledOption>
                <StyledOption value={3}>Colt Steel</StyledOption>
              </CustomSelect>
            </FormControl>
            <FormControl required>
              <FormLabel
